...
{
    //AES is a symmetric encryption algorithm, meaning that the same key can be used to encrypt and 
    //decrypt passed in strings
    ...
    public class AESCryptographyService : IAESCryptographyService
    {
        ...
        {
            _key = configuration["AESKeys:VermittlerKey"];
        }
