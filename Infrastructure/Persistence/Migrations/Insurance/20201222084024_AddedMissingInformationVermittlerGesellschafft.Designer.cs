...
namespace Infrastructure.Persistence.Migrations.Insurance
{
    ...
    [Migration("20201222084024_AddedMissingInformationVermittlerGesellschafft")]
    partial class AddedMissingInformationVermittlerGesellschafft
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Insurance.VermittlerGesellschafft", b =>
                {
                    b.Property<int>("VermittlerId")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("Abschlussvergütung")
                        .HasColumnType("double");

                    b.Property<double>("Bestandsvergütung")
                        .HasColumnType("double");
                    ...
                    b.Property<int>("MaxLaufzeitVergütung")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VermittlerNo")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.HasKey("VermittlerId", "GesellschaftId");

                    b.HasIndex("GesellschaftId");

                    b.ToTable("VermittlerGesellschafften");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Insurance.VermittlerGesellschafft", b =>
                {
                    b.HasOne("Domain.Entities.Insurance.Gesellschaft", "Gesellschaft")
                        .WithMany("VermittlerGesellschafften")
                        .HasForeignKey("GesellschaftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
