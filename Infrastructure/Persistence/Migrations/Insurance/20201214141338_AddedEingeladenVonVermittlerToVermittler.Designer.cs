...
namespace Infrastructure.Persistence.Migrations.Insurance
{
    ...
    [Migration("20201214141338_AddedEingeladenVonVermittlerToVermittler")]
    partial class AddedEingeladenVonVermittlerToVermittler
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Insurance.Einladecode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Insurance.Vermittler", b =>
                {
                    ...
                    b.Property<int?>("EingeladenVonVermittlerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EingeladenVonVermittlerId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Insurance.Einladecode", b =>
                {
                    b.HasOne("Domain.Entities.Insurance.Vermittler", null)
                        .WithOne("Einladecode")
                        .HasForeignKey("Domain.Entities.Insurance.Einladecode", "VermittlerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.Entities.Insurance.Vermittler", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Insurance.Vermittler", "EingeladenVon")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Insurance.Vermittler", "EingeladenVonVermittlerId")
                        .OnDelete(DeleteBehavior.SetNull);
