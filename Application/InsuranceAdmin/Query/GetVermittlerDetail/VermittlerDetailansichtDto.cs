...
{
    public class VermittlerDetailansichtDto : IMapFrom<Vermittler>
    {
        ...
        public IList<VermittlerVertragsdokumenteUebersichtDto> VermittlerRegistrierungsdokumenteUebersicht { get; set; }
        public void Mapping(Profile profile)
        {
            profile.CreateMap<Vermittler, VermittlerDetailansichtDto>()
                ...
                .ForMember(dest => dest.VermittlerRegistrierungsdokumenteUebersicht,
                    opt =>
